#-------------------------------------------------------------------------------
# Name:       polarchannelsim_FERvsR_derate_pch.py
...
for N in Nlist:
	for design_p in design_plist:
		...
		f1=open("./simresults/polarchannel_FERvsR_derate_pchFD"+str(N)+"_"+str(design_p)+"_"+stamp+".txt",'w')
		...
		for R in Ratelist:
			if R<=(C/N):
				...
				I=I_order[:K]
				#print R					
				block_error=pch.polarchannelsim_FDin(N,design_p,design_p,I,runsim,False)
				used_rate.append(R)
