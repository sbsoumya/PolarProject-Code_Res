...
the name mxmn is due to fow Lambda is chosen here
"""
#----------------------------------------
import numpy as np
import math as ma
...
f1=open("./simresults/lambda_prob_mxmn"+stamp+".txt",'w')
...
for channel_p in channel_plist:
	...
	for i in range(runsim):
		...
		llr_Fmax=max(ec.getchannel(L,B,False))
