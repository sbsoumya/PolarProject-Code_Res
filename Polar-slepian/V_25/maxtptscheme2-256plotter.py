...
#~ plt.plot(range(N),[10**Z for Z in Z1],"g",label="$p_1=0.03,R_1=186/$"+str(N))
#~ plt.plot(range(N),[10**Z for Z in Z2],"r",label="$p_2=0.11,R_2=93/$"+str(N))
#~ plt.plot(range(N),[10**Z for Z in Z3],"b",label="$p_3=0.17,R_3=62/$"+str(N))
#~ #plt.plot(range(N),[10**z1-10**z2 for (z1,z2) in zip(Z1,Z2)],"k")


#~ plt.title("Choice of $R$ based on $Z(W) \leq 5*10^{-1}$,N 256 \nand satisfying $R_2=R_1/2,R_3=R_1/3$ ") 
#~ plt.legend(loc="best")
#~ plt.grid(True)
...
#=================================================Plot PMD estimates---Not updated
...
TPTfilep1="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt186in256_c0p03_18-05-16_22-00-02.txt"
TPTfilep3="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt186in256_c0p17_18-05-16_21-54-57.txt"
TPTfilep2="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt186in256_c0p11_18-05-16_21-57-38.txt"
