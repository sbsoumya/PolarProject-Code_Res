...
p2=0.11
p3=0.17
(I,Z1)=pcon.getreliability_orderZMC(N,p1,False,100000)
(I,Z2)=pcon.getreliability_orderZMC(N,p2,False,100000)
(I,Z3)=pcon.getreliability_orderZMC(N,p3,False,100000)
...
#~ fileT8="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_510in1024_T8_18-04-28_15-30-03.txt"
#~ complist=[0.03,0.11,0.17]
#~ N=1024
#~ fig=plt.figure()
