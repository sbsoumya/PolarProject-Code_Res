...
for N in Nlist:
	...
	for channel_p in channel_plist:
		...
		(u_rate,ach_rate,block_error,Iter_probdict)=rlf.send_rateless_file_Iter_retro_det_CRC32_sim(N,T,compound_plist,channel_p,error_free_msg_length,runsim,False)
		used_rate.append(u_rate) # Starting rate
		achieved_rate.append(ach_rate) # E{D}/N
		FER.append(block_error) # ep
		Iter_problist.append(Iter_probdict) #E{I}
