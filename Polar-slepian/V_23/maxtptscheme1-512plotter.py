...
#~ plt.plot(range(N),[10**Z for Z in Z1],"g",label="$p_1=0.03,R_1=246/512$")
...
#~ TlistANA=[1,2,4,8,16,32,64]


#~ fig=plt.figure()
#~ fig.suptitle("Estimation of $P_{MD},P_{F}$ for N=512,$NR_1=$"+str(NR_p1)+"\n p_1=$"+str(p_1)+"$p_2=$"+str(p_2)+"$p_3=$"+str(p_3))

#~ plt.subplot(221)
#~ #pf1
#~ PF1=pfunionZ(TlistANA,N,NR_p1,p_1) 
#~ pf1file="./simresults/polarchannel_FERvsp_FRSB0p03_246in512_18-05-04_23-22-44.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pmd1file="./simresults/polarchannel_FERvsp_FRSB0p11_246in512_18-05-04_23-22-38.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pf2file="./simresults/polarchannel_FERvsp_FRSB0p11_123in512_18-05-04_23-22-57.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pmd2file="./simresults/polarchannel_FERvsp_FRSB0p17_123in512_18-05-04_23-22-50.txt"
#~ (x,y,z)=(8,9,10)
...
FER3file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_246in512_T0_doiter3_18-05-04_23-26-07.txt"
FER2file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_246in512_T0_doiter2_18-05-04_23-26-05.txt"
FER1file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_246in512_T0_doiter1_18-05-04_23-26-02.txt"

TPTfilep1="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt246in512_c0p03_18-05-04_23-29-56.txt"
TPTfilep2="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt246in512_c0p11_18-05-04_23-30-13.txt"
TPTfilep3="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt246in512_c0p17_18-05-04_23-30-06.txt"
...
#~ fileT32="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_510in512_T32_18-04-28_15-31-33.txt"
#~ fileT1="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_510in512_T1_18-04-28_15-29-44.txt"
#~ fileT11="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_510in512_T11_18-04-29_14-56-55.txt"
#~ fileT8="/home/smart/Desktop/Project/code/Polar-slepian/V_22/simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_510in512_T8_18-04-28_15-30-03.txt"
#~ complist=[0.03,0.11,0.17]
#~ N=512
#~ fig=plt.figure()
#~ fig.suptitle("HARQ schemes  \n N=512,ED for $\{p_1=$"+str(np.round(complist[0],decimals=3)) +"$,p_2=$"+str(np.round(complist[1],decimals=3)) +"$,p_3= $"+str(np.round(complist[2],decimals=3))+"$ \}$")
#~ R_p1=510
#~ maxiters=3
#~ (x,y,z)=(9,10,11)
#~ T=1
...
#==================UK
#~ T=0
#~ fileUK="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_UK510in512_T0_18-05-03_15-42-41.txt"
