...
#~ plt.title("Choice of $R$ based on $Z(W) \leq 5*10^{-2}$,N ="+str(N)+" \nand satisfying $R_2=R_1/2,R_3=R_1/3$ ") 
#~ plt.legend(loc="best")
#~ plt.grid(True)
...
#~ fig=plt.figure()
#~ fig.suptitle("Estimation of $P_{MD},P_{F}$ for N=128,$NR_1=$"+str(NR_p1)+"\n p_1=$"+str(p_1)+"$p_2=$"+str(p_2)+"$p_3=$"+str(p_3))

#~ plt.subplot(221)
#~ #pf1
#~ PF1=pfunionZ(TlistANA,N,NR_p1,p_1) 
#~ pf1file="./simresults/polarchannel_FERvsp_FRSB0p03_1020in128_18-05-04_21-41-49.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pmd1file="./simresults/polarchannel_FERvsp_FRSB0p11_1020in128_18-05-04_21-43-43.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pf2file="./simresults/polarchannel_FERvsp_FRSB0p11_510in128_18-05-04_21-40-46.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pmd2file="./simresults/polarchannel_FERvsp_FRSB0p17_510in128_18-05-04_21-42-59.txt"
#~ (x,y,z)=(8,9,10)
...
#~ FER1file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_42in128_T0_doiter1_18-05-07_12-59-23.txt"
#~ FER2file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_42in128_T0_doiter2_18-05-07_12-59-17.txt"
#~ FER3file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_42in128_T0_doiter3_18-05-07_12-59-09.txt"


#~ #maxtpt
#~ TPTfilep3="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt42in128_c0p17_18-05-07_12-51-22.txt"
#~ TPTfilep2="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt42in128_c0p11_18-05-07_12-51-12.txt"
#~ TPTfilep1="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt42in128_c0p03_18-05-07_12-50-52.txt"
