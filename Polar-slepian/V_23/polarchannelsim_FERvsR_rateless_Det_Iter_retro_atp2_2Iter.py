...
#~ [508, 238, 148, 103, 76]
doiter=2
#channel_plist=list(np.linspace(0.05,0.20699999999999974,8))
channel_plist=[compound_plist[1]]
T=0
R_p1list=[540,360,120]
...
for N in Nlist:
	...
	filename="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_atp2_doiter"+str(doiter)+"_"+stamp+".txt"
	f1=open(filename,'w')
	print filename
