...
#~ plt.plot(range(N),[10**Z for Z in Z1],"g",label="$p_1=0.03,R_1="+str(R_p1)+"/"+str(N)+"$")
#~ plt.plot(range(N),[10**Z for Z in Z2],"r",label="$p_2=0.11,R_2="+str(R_p1/2)+"/"+str(N)+"$")
#~ plt.plot(range(N),[10**Z for Z in Z3],"b",label="$p_3=0.17,R_3="+str(R_p1/3)+"/"+str(N)+"$")
#~ #plt.plot(range(N),[10**z1-10**z2 for (z1,z2) in zip(Z1,Z2)],"k")
#~ print pl.CapacityBSC(64,p1)/3

#~ plt.title("Choice of $R$ based on $Z(W) \leq 5*10^{-2}$,N =64 \nand satisfying $R_2=R_1/2,R_3=R_1/3$ ") 
#~ plt.legend(loc="best")
#~ plt.grid(True)
#~ print pl.CapacityBSC(64,p2)
#~ print pl.CapacityBSC(64,p3)
#~ #print pl.Inversecap64(pl.CapacityBSC(64,p1)/3)
#~ plt.show()
...
#~ fig=plt.figure()
#~ fig.suptitle("Estimation of $P_{MD},P_{F}$ for N=64,$NR_1=$"+str(NR_p1)+"\n p_1=$"+str(p_1)+"$p_2=$"+str(p_2)+"$p_3=$"+str(p_3))

#~ plt.subplot(221)
#~ #pf1
#~ PF1=pfunionZ(TlistANA,N,NR_p1,p_1) 
#~ pf1file="./simresults/polarchannel_FERvsp_FRSB0p03_1020in64_18-05-04_21-41-49.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pmd1file="./simresults/polarchannel_FERvsp_FRSB0p11_1020in64_18-05-04_21-43-43.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pf2file="./simresults/polarchannel_FERvsp_FRSB0p11_510in64_18-05-04_21-40-46.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pmd2file="./simresults/polarchannel_FERvsp_FRSB0p17_510in64_18-05-04_21-42-59.txt"
#~ (x,y,z)=(8,9,10)
...
#~ FER1file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_18in64_T0_doiter1_18-05-07_13-00-43.txt"
#~ FER2file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_18in64_T0_doiter2_18-05-07_13-00-49.txt"
#~ FER3file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_18in64_T0_doiter3_18-05-07_13-00-55.txt"


#~ #maxtpt
#~ TPTfilep3="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt18in64_c0p17_18-05-07_12-55-28.txt"
#~ TPTfilep2="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt18in64_c0p11_18-05-07_12-55-23.txt"
#~ TPTfilep1="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt18in64_c0p03_18-05-07_12-55-15.txt"
...
fileT3="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_18in64_T3_18-05-07_14-41-30.txt"
...
#~ #==================UK
T=0
fileUK="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_UK18in64_T0_18-05-07_12-40-34.txt"
