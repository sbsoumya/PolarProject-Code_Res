...
plt.plot(range(N),[10**Z for Z in Z1],"g",label="$p_1=0.03,R_1=1020/2048$")
plt.plot(range(N),[10**Z for Z in Z2],"r",label="$p_2=0.11,R_2=510/2048$")
plt.plot(range(N),[10**Z for Z in Z3],"b",label="$p_3=0.17,R_3=340/2048$")
#plt.plot(range(N),[10**z1-10**z2 for (z1,z2) in zip(Z1,Z2)],"k")
print pl.CapacityBSC(2048,p1)/3

plt.title("Choice of $R$ based on $Z(W) \leq 5*10^{-2}$,N =2048 \nand satisfying $R_2=R_1/2,R_3=R_1/3$ ") 
plt.legend(loc="best")
plt.grid(True)
print pl.CapacityBSC(2048,p2)
print pl.CapacityBSC(2048,p3)
#print pl.Inversecap2048(pl.CapacityBSC(2048,p1)/3)
plt.show()
...
#~ fig=plt.figure()
#~ fig.suptitle("Estimation of $P_{MD},P_{F}$ for N=2048,$NR_1=$"+str(NR_p1)+"\n p_1=$"+str(p_1)+"$p_2=$"+str(p_2)+"$p_3=$"+str(p_3))

#~ plt.subplot(221)
#~ #pf1
#~ PF1=pfunionZ(TlistANA,N,NR_p1,p_1) 
#~ pf1file="./simresults/polarchannel_FERvsp_FRSB0p03_1020in2048_18-04-26_21-57-42.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pmd1file="./simresults/polarchannel_FERvsp_FRSB0p11_1020in2048_18-04-26_21-56-52.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pf2file="./simresults/polarchannel_FERvsp_FRSB0p11_510in2048_18-04-26_22-02-37.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pmd2file="./simresults/polarchannel_FERvsp_FRSB0p17_510in2048_18-04-26_21-59-03.txt"
#~ (x,y,z)=(8,9,10)
...
#~ FER3file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_1020in2048_T0_doiter3_18-04-26_22-04-23.txt"
#~ FER2file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_1020in2048_T0_doiter2_18-04-26_22-05-14.txt"
#~ FER1file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_1020in2048_T0_doiter1_18-04-26_22-06-46.txt"

#~ TPTfilep1="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt1020in2048_c0p03_18-04-27_14-50-18.txt"
#~ TPTfilep2="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt1020in2048_c0p11_18-04-27_14-48-37.txt"
#~ TPTfilep3="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt1020in2048_c0p17_18-04-27_14-47-21.txt"
...
#~ fileT32="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_1020in2048_T32_18-04-28_15-31-33.txt"
#~ fileT1="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_1020in2048_T1_18-04-28_15-29-44.txt"
#~ fileT11="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_1020in2048_T11_18-04-29_14-56-55.txt"
#~ fileT8="/home/smart/Desktop/Project/code/Polar-slepian/V_22/simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_1020in2048_T8_18-04-28_15-30-03.txt"
#~ complist=[0.03,0.11,0.17]
#~ N=2048
#~ fig=plt.figure()
...
#==================UK
#~ T=0
#~ fileUK="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_UK1020in2048_T0_18-05-03_15-42-41.txt"
