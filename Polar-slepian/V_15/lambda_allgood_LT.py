#---------------------------------------------------
# Name:       lambda_allgood_LT.py
# Purpose:    Probability of all goodchannels above a threshold LT
#
# Author:      soumya
#
# Created:    24/10/2017
...
f1=open("./simresults/lambda_allgood_LT"+stamp+".txt",'w')
...
Pdict=lmb.P_allgood(channel_plist,design_p,I,N,LT,runsim,RI,False)
