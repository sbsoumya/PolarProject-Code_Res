...
#filename0="./simresults/polarchannel_FERvsR_derate1024_0.04_17-12-27_16-43-37.txt"
...
#plt.subplot(2,1,1)
plt.semilogy(table0[7],[10**i for i in table0[8]],'k-o',label="Polar Code for p="+str(p))
