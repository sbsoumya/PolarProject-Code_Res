...
plt.plot(range(N),[10**Z for Z in Z1],"g",label="$p_1=0.03,R_1=372/512$")
plt.plot(range(N),[10**Z for Z in Z2],"r",label="$p_2=0.11,R_2=186/512$")
plt.plot(range(N),[10**Z for Z in Z3],"b",label="$p_3=0.17,R_3=124/512$")
#plt.plot(range(N),[10**z1-10**z2 for (z1,z2) in zip(Z1,Z2)],"k")


plt.title("Choice of $R$ based on $Z(W) \leq 5*10^{-1}$,N =512 \nand satisfying $R_2=R_1/2,R_3=R_1/3$ ") 
plt.legend(loc="best")
plt.grid(True)
...
TPTfilep1="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt372in512_c0p03_18-05-16_21-41-04.txt"
TPTfilep2="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt372in512_c0p11_18-05-16_21-41-22.txt"
TPTfilep3="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt372in512_c0p17_18-05-16_21-41-33.txt"
