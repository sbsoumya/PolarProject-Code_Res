...
filename="./simresults/polarchannel_FERvsp_FRTV"+str(msg_length)+"in"+str(N)+"_"+stamp+".txt"
f1=open(filename,'w')
print filename
print "P Vs FER REPORT derate TV"
print "---------------------------"
print "N="+str(N)
print "sim ran :"+str(runsim)
print "msg_length:"+str(msg_length)
		
json.dump( "P Vs FER REPORT derate TV",f1) ;f1.write("\n")
...
for design_p in design_plist:
	print design_p
	block_error=pch.polarchannelsim_FRTV(N,design_p,design_p,msg_length,runsim,False)
	#~ if block_error==0:
