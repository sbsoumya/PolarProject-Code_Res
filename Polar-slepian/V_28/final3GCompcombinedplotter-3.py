...
files41=['./simresults/polarfile_FERvsR_rateless_Det_Iter_retro3G_NB_1_512in1024_T128_18-10-24_22-17-27.txt', 
...
#empirical
files41=['./simresults/polarfile_FERvsR_rateless_Det_Iter_retro3G_NB_1_512in1024_T128_19-01-01_00-15-57.txt',
...
"""
#512
files45=['./simresults/polarfile_FERvsR_rateless_Det_Iter_retro3G_NB_1_246in512_T9_18-10-26_00-50-41.txt', 
...
files45=['./simresults/polarfile_FERvsR_rateless_Det_Iter_retro3G_NB_1_246in512_T9_18-12-31_23-46-35.txt', 
...
#CRC
files55=['./simresults/polarfile_FERvsR_rateless_Det_Iter_retro3G_NB_1_246in512_T9_19-01-04_22-10-40.txt', 
...
errexp=lines[3]
Empirical=lines[4]
EmpiricalCRC=ml.getline(files55[usefile],[-1])[0]
print Empirical
#print EmpiricalCRC
point=len(lines[1])
...
#plt.plot(p2,z,label="l(p) by formula",color="green",marker="^")
#plt.plot(p2,theory,label="Theoretical, n="+str(N),color="black",marker=">")
plt.plot(p2,Empirical,label="RB-PDE",color="green", marker="^")
plt.plot(p2,EmpiricalCRC,label="RB-PDE with CRC",color="blue",marker="x")
...
#plt.plot(p2,Empirical,label="RB-PDE, n="+str(N),color="blue", marker="^")
