...
for N in Nlist:
	...
	for channel_p in channel_plist:
		...
		(u_rate,ach_rate,block_error,Iter_probdict)=rlf.send_rateless_file_Iter_retro_det_CRC8_sim(N,T,compound_plist,channel_p,error_free_msg_length,runsim,False)
