...
plt.title("$R_{p_1} =$ error\_free\_communication for $Y=X \oplus Ber(p_1)$ ") 
...
#==============
E_G=[(1-float(Rp1_8)/N)/MeanIters[i] for i in range(point)]
TPT= [E_G[i]*(1-10**lines[2][i]) for i in range(point)]
EFCOM=[1-TPT[i] for i in range(point)]
#===================================
plt.plot(lines[0],EFCOM,'-g^',label='CB 8bits, $NR_{p_1}=$'+str(Rp1_8))
#plt.plot(lines[0],EFTPT,':go',label='CB 8bits, $NR_{p_1}=$'+str(Rp1_8))
(x,y,z)=(8,9,10)
...
EFCOM=[1-TPT[i] for i in range(point)]
#===================================
plt.plot(lines[0],EFCOM,'-.g^',label='CB 32bits,$NR_{p_1}=$'+str(Rp1_32))
#plt.plot(lines[0],EFTPT,':g>',label='CB 8bits, $NR_{p_1}=$'+str(Rp1_32))
#TPT 700=====================================================================================
#TPT files
...
EFCOM=[1-TPT[i] for i in range(point)]
#===================================
plt.plot(lines[0],EFCOM,'-r^',label='CB 8bits, $NR_{p_1}=$'+str(Rp1_8))
#plt.plot(lines[0],EFTPT,':ro',label='CB 8bits, $NR_{p_1}=$'+str(Rp1_8))
(x,y,z)=(8,9,10)
lines=ml.getline(Iterretrofile32,[x,y,z])
point=len(lines[0])
MeanIters=pl.getMeanIter(ml.getline(Iterretrofile32,[12])[0],5)
...
EFCOM=[1-TPT[i] for i in range(point)]
#===================================
plt.plot(lines[0],EFCOM,'-.r^',label='CB 32bits,$NR_{p_1}=$'+str(Rp1_32))
...
EFCOM=[1-TPT[i] for i in range(point)]
#===================================
plt.plot(lines[0],EFCOM,'-b^',label='CB 8bits, $NR_{p_1}=$'+str(Rp1_8))
#plt.plot(lines[0],EFTPT,':bo',label='CB 8bits, $NR_{p_1}=$'+str(Rp1_8))
(x,y,z)=(8,9,10)
lines=ml.getline(Iterretrofile32,[x,y,z])
point=len(lines[0])
MeanIters=pl.getMeanIter(ml.getline(Iterretrofile32,[12])[0],5)
...
#===================================
EFTPT=[(1-(1-float(lines[1][i])*MeanIters[i])*(1-10**lines[2][i])) for i in range(point)]
plt.plot(lines[0],EFCOM,'-.b^',label='CB 32bits,$NR_{p_1}=$'+str(Rp1_32))
...
#plt.plot(lines[0],EFTPT,':yo',label='CB 8bits, $NR_{p_1}=$'+str(Rp1_8))
plt.plot(lines[0],EFCOM,'-y^',label='CB 8bits, $NR_{p_1}=$'+str(Rp1_8))
(x,y,z)=(8,9,10)
lines=ml.getline(Iterretrofile32,[x,y,z])
point=len(lines[0])
MeanIters=pl.getMeanIter(ml.getline(Iterretrofile32,[12])[0],5)
...
EFCOM=[1-TPT[i] for i in range(point)]
#===================================
plt.plot(lines[0],EFCOM,'-.y^',label='CB 32bits,$NR_{p_1}=$'+str(Rp1_32))
#--------------------------------------------
#E[G_final]=(1-R_{p_1})/E[Iterations]
#TPT = G_final*(1-FER)
#1-TPT = error free comm
#--------------------------------------------
plt.ylabel('Error free communication=$1-(1-R_{p_1})*(1-FER)/E[Iterations]$')
plt.xlabel('BSC(p)')
plt.grid(True)
plt.legend(loc="best")
