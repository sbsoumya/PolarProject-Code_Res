...
points2=20
compound_plist=[0.03,0.15,0.3,0.45]
channel_p0=0.03
channel_p1list=[0.07]#,0.11,0.17]
...
for N in Nlist:
	...
	for channel_p1 in channel_p1list:
		channel_p2_start=0.11
		channel_p2list=list(np.linspace(channel_p2_start,0.5,points2))
		#channel_p2list=[0.11]
		...
		if MC:
			filename="./simresults/polarfile_FERvsR_rateless_Det_Iter_retro4G_NB_MC1_"+str(fc).replace(".",'p')+"_"+str(R_p1)+"in"+str(N)+"_T"+str(T)+"_"+stamp+".txt"
		else:
