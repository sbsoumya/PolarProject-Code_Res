...
for N in Nlist:
	...
	for channel_p1 in channel_p1list:
		...
		#print "channel_p:"+str(channel_p)
			(ach_rate,block_error,decoded,error_array,Iter_prob,D_array,Emp_comp)=rlf.send_rateless_file_Iter_retro_det_3G_sim(N,T,compound_plist,channel_p1,channel_p2,error_free_msg_length,runsim,False)
