...
for N in Nlist:
	for channel_p in channel_plist:
		...
		f1=open("./simresults/polarchannel_FERvsR_derate_rateless"+str(N)+"_"+str(channel_p)+"_"+stamp+".txt",'w')
		...
		for derate in deratelist:
			(ach_rate,u_rate,block_error)=rlc.send_rateless_kRx_sim(N,channel_plist,channel_p,derate,runsim,False)
