...
for N in Nlist:
	...
	json.dump( "Min_Iter="+str(Min_Iter),f1) ;f1.write("\n")
	...
	for T in Tlist:
		msg_length=R_p1-T
		print "T:"+str(T)
		(u_rate,ach_rate,block_error,Iter_probdict)=rlc.send_rateless_det_Iter_retro_MinIter_sim(N,T,compound_plist,channel_p,msg_length,Min_Iter,runsim)
