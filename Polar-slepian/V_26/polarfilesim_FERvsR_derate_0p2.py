...
for N in Nlist:
	for design_p in design_plist:
		...
		f1=open("./simresults/polarfile_FERvsR_derate"+str(N)+"_"+str(design_p)+"_"+stamp+".txt",'w')
			
		print "RATE Vs FER REPORT FILE derate"
		print "-------------------------------"
		print "N="+str(N)
		...
		json.dump( "RATE Vs FER REPORT FILE derate",f1) ;f1.write("\n")
		...
		for derate in deratelist:
				(ach_rate,block_error)=pf.polarfile_derate_sim(N,design_p,design_p,derate,runsim,False)
