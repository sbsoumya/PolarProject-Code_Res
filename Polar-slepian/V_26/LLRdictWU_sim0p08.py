#---------------------------------------------------
# Name:       LLRdictWU_sim.py
# Purpose:    Generate LLRdict (not absolute) file with WU sim
#
# Author:      soumya
#
# Created:    15/02/2018
...
N=1024
channel_plist=[0.08349999999999963, 0.19249999999999973, 0.24549999999999977, 0.2784999999999998, 0.3009999999999998]
channel_plist.sort()
...
f2name=lmb.get_LLRdictWU(channel_plist,design_p,I,N,runsim,RI)
