...
for N in Nlist:
	...
	filename="./simresults/polarfile_FERvsR_rateless_Det_Iter_retro_UK"+str(R_p1)+"in"+str(N)+"_UK_"+stamp+".txt"
	f1=open(filename,'w')
	print filename
	...
	for channel_p in channel_plist:
		...
		(u_rate,ach_rate,block_error,Iter_probdict)=rlf.send_rateless_file_Iter_retro_det_UK_sim(N,compound_plist,channel_p,error_free_msg_length,runsim)
