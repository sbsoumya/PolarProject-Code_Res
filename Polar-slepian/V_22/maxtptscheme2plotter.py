...
#~ plt.plot(range(N),[10**Z for Z in Z1],"g",label="$p_1=0.03,R_1=678/1024$")
#~ plt.plot(range(N),[10**Z for Z in Z2],"r",label="$p_2=0.11,R_2=339/1024$")
#~ plt.plot(range(N),[10**Z for Z in Z3],"b",label="$p_3=0.17,R_3=226/1024$")
...
#~ pf1file="./simresults/polarchannel_FERvsp_FRSB0p03_678in1024_18-04-28_16-12-02.txt"
#~ (x,y,z)=(8,9,10)
#~ lines=ml.getline(pf1file,[x,y,z])
#~ Tlist=lines[0]
#~ PF1sim=[10**e for e in lines[1]]
#~ plt.plot(TlistANA,PF1,"-r^",label="Ana")
#~ #plt.plot(TlistANA,PF1M,"-g^",label="Ana-MC")
...
#~ pmd1file="./simresults/polarchannel_FERvsp_FRSB0p11_678in1024_18-04-28_16-11-24.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pf2file="./simresults/polarchannel_FERvsp_FRSB0p11_339in1024_18-04-28_16-13-49.txt"
#~ (x,y,z)=(8,9,10)
...
#~ pmd2file="./simresults/polarchannel_FERvsp_FRSB0p17_339in1024_18-04-28_16-13-00.txt"
#~ (x,y,z)=(8,9,10)
...
#~ FER3file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_678in1024_T0_doiter3_18-04-28_16-24-08.txt"
#~ FER2file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_678in1024_T0_doiter2_18-04-28_16-24-29.txt"
#~ FER1file="./simresults/polarchannel_FERvsR_rateless_Det_Iter_retro_678in1024_T0_doiter1_18-04-28_16-24-51.txt"

#~ TPTfilep1="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt678in1024_c0p03_18-04-28_16-23-58.txt"
#~ TPTfilep2="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt678in1024_c0p11_18-04-28_16-24-53.txt"
#~ TPTfilep3="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt678in1024_c0p17_18-04-28_16-24-31.txt"

#~ TPTfilep21="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt678in1024_c0p11_18-04-29_16-10-34.txt"
#~ TPTfilep31="./simresults/polarchannel_FERvsR_rateless_Det_Iter_maxtpt678in1024_c0p17_18-04-29_16-12-24.txt"
...
#~ newlines=ml.getline(TPTfilep21,[x,z])
#~ lines[0].extend(newlines[0])
#~ lines[1].extend(newlines[1])
#~ (lines[0],lines[1])=ml.sortAextend(lines[0],lines[1])
...
#~ newlines=ml.getline(TPTfilep31,[x,z])
#~ lines[0].extend(newlines[0])
#~ lines[1].extend(newlines[1])
#~ (lines[0],lines[1])=ml.sortAextend(lines[0],lines[1])
...
point=len(lines[0])
MeanIters=pl.getMeanIter(ml.getline(fileT7,[13])[0],5)
...
point=len(lines[0])
MeanIters=pl.getMeanIter(ml.getline(fileT101,[13])[0],5)
