...
a= computeFrozenIndices(channel, n=10, mu=256, threshold=None, rate=0.5)
print a
channel = BMSChannel.BSC(0.5)
b= computeFrozenIndices(channel, n=10, mu=2, threshold=None, rate=0.5)
